 ...
 */
public class AddContactsWin extends PopupWindow {

    private View main;
    private LinearLayout choose_layout,add_layout;
    private TextView item1;
    private TextView item2;
    public AddContactsWin(Activity activity, View.OnClickListener paramOnClickListener, int paramInt1, int paramInt2) {
        super(activity);

        main = LayoutInflater.from(activity).inflate(R.layout.pop_more,null);
